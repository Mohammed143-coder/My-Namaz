...
const Home = () => {
  ...
  const filterMasjids = allMasjids.filter((item) =>
    searchMasjid
      ? item.name.toLowerCase().includes(searchMasjid.toLowerCase()) ||
        item.location.toLowerCase().includes(searchMasjid.toLowerCase())
      : true
  );
  ...
  return (
    <main className="text-black overflow-y-auto mt-15 md:mt-18">
      ...
      <div className="m-2 h-[70%] overflow-y-auto text-black">
        <h5 className="ml-2 mt-2 font-medium text-black">
